...
> 📘 **CI/CD 实战版教程第三部分**  
> 📌 包含：安装配置、GitLab 集成、参数化构建

---

## 目录

- [第 6 章 Jenkins 安装配置](#第 6 章-jenkins 安装配置)
- [第 7 章 Jenkins 与 GitLab 集成](#第 7 章-jenkins 与-gitlab 集成)
- [第 8 章 Jenkins 参数化构建](#第 8 章-jenkins 参数化构建)
